...
namespace TheAmazingBookStore.Controller.Tests.Commands.Updating.BookUpdateCommands.UpdateBookRatingTests
{
    [TestClass]
    public class Constructor_Should
    {
        ...
        public void CreateInstance_WhenParametersAreCorrect()
        {
            ...
            // Act
            var command = new UpdateBookRating(mockContext.Object);
        ...
        {
            // Act & Assert
            Assert.ThrowsException<ArgumentNullException>(() => new UpdateBookRating(null));
        }
    }
}
